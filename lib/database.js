(function(){
	...
	*/
	module.exports.addNewGame = function(connection, name, description, imgURL, datetime, user){
	...
	module.exports.addNewGameFile = function(connection, game_name, file, user){
	...
	module.exports.updateGameFiles = function(connection, game_name, files, user){
	...
	module.exports.getGamefiles = function(connection, game_name, user){
